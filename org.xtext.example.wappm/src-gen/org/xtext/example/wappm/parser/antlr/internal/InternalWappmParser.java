...
public class InternalWappmParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_INT", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'webapp'", "'{'", "'}'", "'hypertext'", "'static'", "'path'", "'links'", "','", "'detail'", "'uses'", "'index'", "'size'", "'link'", "'page'", "'content'", "'class'", "'attr'", "':'", "'ref'", "'role'", "'bound['", "']'", "'/'", "'String'", "'Integer'", "'Float'", "'Double'", "'Boolean'"
    };
    ...
    // InternalWappm.g:576:1: ruleIndexPage returns [EObject current=null] : (otherlv_0= 'index' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= 'uses' ( (otherlv_3= RULE_ID ) ) otherlv_4= '{' otherlv_5= 'path' ( (lv_path_6_0= ruleURL ) ) otherlv_7= 'size' ( (lv_size_8_0= RULE_INT ) ) (otherlv_9= 'links' otherlv_10= '{' ( (lv_links_11_0= ruleLink ) ) (otherlv_12= ',' ( (lv_links_13_0= ruleLink ) ) )* otherlv_14= '}' )? otherlv_15= '}' ) ;
    public final EObject ruleIndexPage() throws RecognitionException {
        ...
        try {
            // InternalWappm.g:582:2: ( (otherlv_0= 'index' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= 'uses' ( (otherlv_3= RULE_ID ) ) otherlv_4= '{' otherlv_5= 'path' ( (lv_path_6_0= ruleURL ) ) otherlv_7= 'size' ( (lv_size_8_0= RULE_INT ) ) (otherlv_9= 'links' otherlv_10= '{' ( (lv_links_11_0= ruleLink ) ) (otherlv_12= ',' ( (lv_links_13_0= ruleLink ) ) )* otherlv_14= '}' )? otherlv_15= '}' ) )
            // InternalWappm.g:583:2: (otherlv_0= 'index' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= 'uses' ( (otherlv_3= RULE_ID ) ) otherlv_4= '{' otherlv_5= 'path' ( (lv_path_6_0= ruleURL ) ) otherlv_7= 'size' ( (lv_size_8_0= RULE_INT ) ) (otherlv_9= 'links' otherlv_10= '{' ( (lv_links_11_0= ruleLink ) ) (otherlv_12= ',' ( (lv_links_13_0= ruleLink ) ) )* otherlv_14= '}' )? otherlv_15= '}' )
            {
            // InternalWappm.g:583:2: (otherlv_0= 'index' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= 'uses' ( (otherlv_3= RULE_ID ) ) otherlv_4= '{' otherlv_5= 'path' ( (lv_path_6_0= ruleURL ) ) otherlv_7= 'size' ( (lv_size_8_0= RULE_INT ) ) (otherlv_9= 'links' otherlv_10= '{' ( (lv_links_11_0= ruleLink ) ) (otherlv_12= ',' ( (lv_links_13_0= ruleLink ) ) )* otherlv_14= '}' )? otherlv_15= '}' )
            // InternalWappm.g:584:3: otherlv_0= 'index' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= 'uses' ( (otherlv_3= RULE_ID ) ) otherlv_4= '{' otherlv_5= 'path' ( (lv_path_6_0= ruleURL ) ) otherlv_7= 'size' ( (lv_size_8_0= RULE_INT ) ) (otherlv_9= 'links' otherlv_10= '{' ( (lv_links_11_0= ruleLink ) ) (otherlv_12= ',' ( (lv_links_13_0= ruleLink ) ) )* otherlv_14= '}' )? otherlv_15= '}'
            {
            ...
            otherlv_7=(Token)match(input,22,FOLLOW_17); 
            			...
            			newLeafNode(otherlv_7, grammarAccess.getIndexPageAccess().getSizeKeyword_7());
            		
            // InternalWappm.g:654:3: ( (lv_size_8_0= RULE_INT ) )
            // InternalWappm.g:655:4: (lv_size_8_0= RULE_INT )
            {
            // InternalWappm.g:655:4: (lv_size_8_0= RULE_INT )
            // InternalWappm.g:656:5: lv_size_8_0= RULE_INT
            {
            lv_size_8_0=(Token)match(input,RULE_INT,FOLLOW_12); 

            					newLeafNode(lv_size_8_0, grammarAccess.getIndexPageAccess().getSizeINTTerminalRuleCall_8_0());
            ...
            // InternalWappm.g:672:3: (otherlv_9= 'links' otherlv_10= '{' ( (lv_links_11_0= ruleLink ) ) (otherlv_12= ',' ( (lv_links_13_0= ruleLink ) ) )* otherlv_14= '}' )?
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalWappm.g:673:4: otherlv_9= 'links' otherlv_10= '{' ( (lv_links_11_0= ruleLink ) ) (otherlv_12= ',' ( (lv_links_13_0= ruleLink ) ) )* otherlv_14= '}'
                    {
                    otherlv_9=(Token)match(input,17,FOLLOW_4); 

                    				newLeafNode(otherlv_9, grammarAccess.getIndexPageAccess().getLinksKeyword_9_0());
                    			
                    otherlv_10=(Token)match(input,12,FOLLOW_13); 

                    				newLeafNode(otherlv_10, grammarAccess.getIndexPageAccess().getLeftCurlyBracketKeyword_9_1());
                    			
                    // InternalWappm.g:681:4: ( (lv_links_11_0= ruleLink ) )
                    // InternalWappm.g:682:5: (lv_links_11_0= ruleLink )
                    {
                    // InternalWappm.g:682:5: (lv_links_11_0= ruleLink )
                    // InternalWappm.g:683:6: lv_links_11_0= ruleLink
                    {

                    						newCompositeNode(grammarAccess.getIndexPageAccess().getLinksLinkParserRuleCall_9_2_0());
                    ...
                    // InternalWappm.g:700:4: (otherlv_12= ',' ( (lv_links_13_0= ruleLink ) ) )*
                    loop8:
                    do {
                        int alt8=2;
                        ...
                        switch (alt8) {
                    	case 1 :
                    	    // InternalWappm.g:701:5: otherlv_12= ',' ( (lv_links_13_0= ruleLink ) )
                    	    {
                    	    otherlv_12=(Token)match(input,18,FOLLOW_13); 

                    	    					newLeafNode(otherlv_12, grammarAccess.getIndexPageAccess().getCommaKeyword_9_3_0());
                    	    				
                    	    // InternalWappm.g:705:5: ( (lv_links_13_0= ruleLink ) )
                    	    // InternalWappm.g:706:6: (lv_links_13_0= ruleLink )
                    	    {
                    	    // InternalWappm.g:706:6: (lv_links_13_0= ruleLink )
                    	    // InternalWappm.g:707:7: lv_links_13_0= ruleLink
                    	    {

                    	    							newCompositeNode(grammarAccess.getIndexPageAccess().getLinksLinkParserRuleCall_9_3_1_0());
                    ...
                    otherlv_14=(Token)match(input,13,FOLLOW_7); 
                    				...
                    				newLeafNode(otherlv_14, grammarAccess.getIndexPageAccess().getRightCurlyBracketKeyword_9_4());
            ...
            otherlv_15=(Token)match(input,13,FOLLOW_2); 
            			...
            			newLeafNode(otherlv_15, grammarAccess.getIndexPageAccess().getRightCurlyBracketKeyword_10());
    ...
    // InternalWappm.g:738:1: entryRuleLink returns [EObject current=null] : iv_ruleLink= ruleLink EOF ;
    public final EObject entryRuleLink() throws RecognitionException {
        ...
        try {
            // InternalWappm.g:738:45: (iv_ruleLink= ruleLink EOF )
            // InternalWappm.g:739:2: iv_ruleLink= ruleLink EOF
            {
    ...
    // InternalWappm.g:745:1: ruleLink returns [EObject current=null] : (otherlv_0= 'link' otherlv_1= '{' otherlv_2= 'page' ( (otherlv_3= RULE_ID ) ) otherlv_4= '}' ) ;
    public final EObject ruleLink() throws RecognitionException {
        ...
        try {
            // InternalWappm.g:751:2: ( (otherlv_0= 'link' otherlv_1= '{' otherlv_2= 'page' ( (otherlv_3= RULE_ID ) ) otherlv_4= '}' ) )
            // InternalWappm.g:752:2: (otherlv_0= 'link' otherlv_1= '{' otherlv_2= 'page' ( (otherlv_3= RULE_ID ) ) otherlv_4= '}' )
            {
            // InternalWappm.g:752:2: (otherlv_0= 'link' otherlv_1= '{' otherlv_2= 'page' ( (otherlv_3= RULE_ID ) ) otherlv_4= '}' )
            // InternalWappm.g:753:3: otherlv_0= 'link' otherlv_1= '{' otherlv_2= 'page' ( (otherlv_3= RULE_ID ) ) otherlv_4= '}'
            {
            ...
            // InternalWappm.g:765:3: ( (otherlv_3= RULE_ID ) )
            // InternalWappm.g:766:4: (otherlv_3= RULE_ID )
            {
            // InternalWappm.g:766:4: (otherlv_3= RULE_ID )
            // InternalWappm.g:767:5: otherlv_3= RULE_ID
            {
    ...
    // InternalWappm.g:786:1: entryRuleContentLayer returns [EObject current=null] : iv_ruleContentLayer= ruleContentLayer EOF ;
    public final EObject entryRuleContentLayer() throws RecognitionException {
        ...
        try {
            // InternalWappm.g:786:53: (iv_ruleContentLayer= ruleContentLayer EOF )
            // InternalWappm.g:787:2: iv_ruleContentLayer= ruleContentLayer EOF
            {
    ...
    // InternalWappm.g:793:1: ruleContentLayer returns [EObject current=null] : (otherlv_0= 'content' ( (lv_contentName_1_0= RULE_ID ) ) otherlv_2= '{' ( (lv_classes_3_0= ruleWebClass ) )+ otherlv_4= '}' ) ;
    public final EObject ruleContentLayer() throws RecognitionException {
        ...
        try {
            // InternalWappm.g:799:2: ( (otherlv_0= 'content' ( (lv_contentName_1_0= RULE_ID ) ) otherlv_2= '{' ( (lv_classes_3_0= ruleWebClass ) )+ otherlv_4= '}' ) )
            // InternalWappm.g:800:2: (otherlv_0= 'content' ( (lv_contentName_1_0= RULE_ID ) ) otherlv_2= '{' ( (lv_classes_3_0= ruleWebClass ) )+ otherlv_4= '}' )
            {
            // InternalWappm.g:800:2: (otherlv_0= 'content' ( (lv_contentName_1_0= RULE_ID ) ) otherlv_2= '{' ( (lv_classes_3_0= ruleWebClass ) )+ otherlv_4= '}' )
            // InternalWappm.g:801:3: otherlv_0= 'content' ( (lv_contentName_1_0= RULE_ID ) ) otherlv_2= '{' ( (lv_classes_3_0= ruleWebClass ) )+ otherlv_4= '}'
            {
            otherlv_0=(Token)match(input,25,FOLLOW_3); 

            			newLeafNode(otherlv_0, grammarAccess.getContentLayerAccess().getContentKeyword_0());
            		
            // InternalWappm.g:805:3: ( (lv_contentName_1_0= RULE_ID ) )
            // InternalWappm.g:806:4: (lv_contentName_1_0= RULE_ID )
            {
            // InternalWappm.g:806:4: (lv_contentName_1_0= RULE_ID )
            // InternalWappm.g:807:5: lv_contentName_1_0= RULE_ID
            {
            ...
            // InternalWappm.g:827:3: ( (lv_classes_3_0= ruleWebClass ) )+
            int cnt10=0;
            loop10:
            do {
                int alt10=2;
                ...
                switch (alt10) {
            	case 1 :
            	    // InternalWappm.g:828:4: (lv_classes_3_0= ruleWebClass )
            	    {
            	    // InternalWappm.g:828:4: (lv_classes_3_0= ruleWebClass )
            	    // InternalWappm.g:829:5: lv_classes_3_0= ruleWebClass
            	    {
    ...
    // InternalWappm.g:854:1: entryRuleWebClass returns [EObject current=null] : iv_ruleWebClass= ruleWebClass EOF ;
    public final EObject entryRuleWebClass() throws RecognitionException {
        ...
        try {
            // InternalWappm.g:854:49: (iv_ruleWebClass= ruleWebClass EOF )
            // InternalWappm.g:855:2: iv_ruleWebClass= ruleWebClass EOF
            {
    ...
    // InternalWappm.g:861:1: ruleWebClass returns [EObject current=null] : (otherlv_0= 'class' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= '{' ( (lv_attributes_3_0= ruleAttribute ) )+ ( (lv_references_4_0= ruleReference ) )* otherlv_5= '}' ) ;
    public final EObject ruleWebClass() throws RecognitionException {
        ...
        try {
            // InternalWappm.g:867:2: ( (otherlv_0= 'class' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= '{' ( (lv_attributes_3_0= ruleAttribute ) )+ ( (lv_references_4_0= ruleReference ) )* otherlv_5= '}' ) )
            // InternalWappm.g:868:2: (otherlv_0= 'class' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= '{' ( (lv_attributes_3_0= ruleAttribute ) )+ ( (lv_references_4_0= ruleReference ) )* otherlv_5= '}' )
            {
            // InternalWappm.g:868:2: (otherlv_0= 'class' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= '{' ( (lv_attributes_3_0= ruleAttribute ) )+ ( (lv_references_4_0= ruleReference ) )* otherlv_5= '}' )
            // InternalWappm.g:869:3: otherlv_0= 'class' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= '{' ( (lv_attributes_3_0= ruleAttribute ) )+ ( (lv_references_4_0= ruleReference ) )* otherlv_5= '}'
            {
            otherlv_0=(Token)match(input,26,FOLLOW_3); 

            			newLeafNode(otherlv_0, grammarAccess.getWebClassAccess().getClassKeyword_0());
            		
            // InternalWappm.g:873:3: ( (lv_name_1_0= RULE_ID ) )
            // InternalWappm.g:874:4: (lv_name_1_0= RULE_ID )
            {
            // InternalWappm.g:874:4: (lv_name_1_0= RULE_ID )
            // InternalWappm.g:875:5: lv_name_1_0= RULE_ID
            {
            lv_name_1_0=(Token)match(input,RULE_ID,FOLLOW_4); 
            ...
            // InternalWappm.g:895:3: ( (lv_attributes_3_0= ruleAttribute ) )+
            int cnt11=0;
            loop11:
            do {
                int alt11=2;
                ...
                switch (alt11) {
            	case 1 :
            	    // InternalWappm.g:896:4: (lv_attributes_3_0= ruleAttribute )
            	    {
            	    // InternalWappm.g:896:4: (lv_attributes_3_0= ruleAttribute )
            	    // InternalWappm.g:897:5: lv_attributes_3_0= ruleAttribute
            	    {
            ...
            // InternalWappm.g:914:3: ( (lv_references_4_0= ruleReference ) )*
            loop12:
            do {
                int alt12=2;
                ...
                switch (alt12) {
            	case 1 :
            	    // InternalWappm.g:915:4: (lv_references_4_0= ruleReference )
            	    {
            	    // InternalWappm.g:915:4: (lv_references_4_0= ruleReference )
            	    // InternalWappm.g:916:5: lv_references_4_0= ruleReference
            	    {

            	    					newCompositeNode(grammarAccess.getWebClassAccess().getReferencesReferenceParserRuleCall_4_0());
            	    ...
            	    state._fsp--;
            	    					...
            	    					add(
            	    						...
            	    						"references",
            	    						lv_references_4_0,
            	    						"org.xtext.example.wappm.Wappm.Reference");
            	    					afterParserOrEnumRuleCall();
            ...
            otherlv_5=(Token)match(input,13,FOLLOW_2); 
            			...
            			newLeafNode(otherlv_5, grammarAccess.getWebClassAccess().getRightCurlyBracketKeyword_5());
    ...
    // InternalWappm.g:941:1: entryRuleAttribute returns [EObject current=null] : iv_ruleAttribute= ruleAttribute EOF ;
    public final EObject entryRuleAttribute() throws RecognitionException {
        ...
        try {
            // InternalWappm.g:941:50: (iv_ruleAttribute= ruleAttribute EOF )
            // InternalWappm.g:942:2: iv_ruleAttribute= ruleAttribute EOF
            {
    ...
    // InternalWappm.g:948:1: ruleAttribute returns [EObject current=null] : (otherlv_0= 'attr' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= ':' ( (lv_type_3_0= ruleAppTypes ) ) ) ;
    public final EObject ruleAttribute() throws RecognitionException {
        ...
        try {
            // InternalWappm.g:954:2: ( (otherlv_0= 'attr' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= ':' ( (lv_type_3_0= ruleAppTypes ) ) ) )
            // InternalWappm.g:955:2: (otherlv_0= 'attr' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= ':' ( (lv_type_3_0= ruleAppTypes ) ) )
            {
            // InternalWappm.g:955:2: (otherlv_0= 'attr' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= ':' ( (lv_type_3_0= ruleAppTypes ) ) )
            // InternalWappm.g:956:3: otherlv_0= 'attr' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= ':' ( (lv_type_3_0= ruleAppTypes ) )
            {
            otherlv_0=(Token)match(input,27,FOLLOW_3); 

            			newLeafNode(otherlv_0, grammarAccess.getAttributeAccess().getAttrKeyword_0());
            		
            // InternalWappm.g:960:3: ( (lv_name_1_0= RULE_ID ) )
            // InternalWappm.g:961:4: (lv_name_1_0= RULE_ID )
            {
            // InternalWappm.g:961:4: (lv_name_1_0= RULE_ID )
            // InternalWappm.g:962:5: lv_name_1_0= RULE_ID
            {
            ...
            // InternalWappm.g:982:3: ( (lv_type_3_0= ruleAppTypes ) )
            // InternalWappm.g:983:4: (lv_type_3_0= ruleAppTypes )
            {
            // InternalWappm.g:983:4: (lv_type_3_0= ruleAppTypes )
            // InternalWappm.g:984:5: lv_type_3_0= ruleAppTypes
            {
    ...
    // InternalWappm.g:1005:1: entryRuleReference returns [EObject current=null] : iv_ruleReference= ruleReference EOF ;
    public final EObject entryRuleReference() throws RecognitionException {
        ...
        try {
            // InternalWappm.g:1005:50: (iv_ruleReference= ruleReference EOF )
            // InternalWappm.g:1006:2: iv_ruleReference= ruleReference EOF
            {
    ...
    // InternalWappm.g:1012:1: ruleReference returns [EObject current=null] : (otherlv_0= 'ref' otherlv_1= '{' otherlv_2= 'role' ( (lv_name_3_0= RULE_ID ) ) otherlv_4= 'bound[' ( (lv_lowBound_5_0= RULE_INT ) ) otherlv_6= ',' ( (lv_upBound_7_0= RULE_INT ) ) otherlv_8= ']' otherlv_9= '}' ) ;
    public final EObject ruleReference() throws RecognitionException {
        ...
        Token otherlv_4=null;
        Token lv_lowBound_5_0=null;
        Token otherlv_6=null;
        Token lv_upBound_7_0=null;
        Token otherlv_8=null;
        Token otherlv_9=null;
        ...
        try {
            // InternalWappm.g:1018:2: ( (otherlv_0= 'ref' otherlv_1= '{' otherlv_2= 'role' ( (lv_name_3_0= RULE_ID ) ) otherlv_4= 'bound[' ( (lv_lowBound_5_0= RULE_INT ) ) otherlv_6= ',' ( (lv_upBound_7_0= RULE_INT ) ) otherlv_8= ']' otherlv_9= '}' ) )
            // InternalWappm.g:1019:2: (otherlv_0= 'ref' otherlv_1= '{' otherlv_2= 'role' ( (lv_name_3_0= RULE_ID ) ) otherlv_4= 'bound[' ( (lv_lowBound_5_0= RULE_INT ) ) otherlv_6= ',' ( (lv_upBound_7_0= RULE_INT ) ) otherlv_8= ']' otherlv_9= '}' )
            {
            // InternalWappm.g:1019:2: (otherlv_0= 'ref' otherlv_1= '{' otherlv_2= 'role' ( (lv_name_3_0= RULE_ID ) ) otherlv_4= 'bound[' ( (lv_lowBound_5_0= RULE_INT ) ) otherlv_6= ',' ( (lv_upBound_7_0= RULE_INT ) ) otherlv_8= ']' otherlv_9= '}' )
            // InternalWappm.g:1020:3: otherlv_0= 'ref' otherlv_1= '{' otherlv_2= 'role' ( (lv_name_3_0= RULE_ID ) ) otherlv_4= 'bound[' ( (lv_lowBound_5_0= RULE_INT ) ) otherlv_6= ',' ( (lv_upBound_7_0= RULE_INT ) ) otherlv_8= ']' otherlv_9= '}'
            {
            ...
            otherlv_2=(Token)match(input,30,FOLLOW_3); 
            			...
            			newLeafNode(otherlv_2, grammarAccess.getReferenceAccess().getRoleKeyword_2());
            		
            // InternalWappm.g:1032:3: ( (lv_name_3_0= RULE_ID ) )
            // InternalWappm.g:1033:4: (lv_name_3_0= RULE_ID )
            {
            // InternalWappm.g:1033:4: (lv_name_3_0= RULE_ID )
            // InternalWappm.g:1034:5: lv_name_3_0= RULE_ID
            {
            ...
            otherlv_4=(Token)match(input,31,FOLLOW_17); 
            			...
            			newLeafNode(otherlv_4, grammarAccess.getReferenceAccess().getBoundKeyword_4());
            		
            // InternalWappm.g:1054:3: ( (lv_lowBound_5_0= RULE_INT ) )
            // InternalWappm.g:1055:4: (lv_lowBound_5_0= RULE_INT )
            {
            // InternalWappm.g:1055:4: (lv_lowBound_5_0= RULE_INT )
            // InternalWappm.g:1056:5: lv_lowBound_5_0= RULE_INT
            {
            lv_lowBound_5_0=(Token)match(input,RULE_INT,FOLLOW_28); 

            					newLeafNode(lv_lowBound_5_0, grammarAccess.getReferenceAccess().getLowBoundINTTerminalRuleCall_5_0());
            ...
            otherlv_6=(Token)match(input,18,FOLLOW_17); 
            			...
            			newLeafNode(otherlv_6, grammarAccess.getReferenceAccess().getCommaKeyword_6());
            		
            // InternalWappm.g:1076:3: ( (lv_upBound_7_0= RULE_INT ) )
            // InternalWappm.g:1077:4: (lv_upBound_7_0= RULE_INT )
            {
            // InternalWappm.g:1077:4: (lv_upBound_7_0= RULE_INT )
            // InternalWappm.g:1078:5: lv_upBound_7_0= RULE_INT
            {
            lv_upBound_7_0=(Token)match(input,RULE_INT,FOLLOW_29); 

            					newLeafNode(lv_upBound_7_0, grammarAccess.getReferenceAccess().getUpBoundINTTerminalRuleCall_7_0());
            ...
            otherlv_8=(Token)match(input,32,FOLLOW_7); 
            			...
            			newLeafNode(otherlv_8, grammarAccess.getReferenceAccess().getRightSquareBracketKeyword_8());
            		
            otherlv_9=(Token)match(input,13,FOLLOW_2); 

            			newLeafNode(otherlv_9, grammarAccess.getReferenceAccess().getRightCurlyBracketKeyword_9());
    ...
    // InternalWappm.g:1106:1: entryRuleURL returns [String current=null] : iv_ruleURL= ruleURL EOF ;
    public final String entryRuleURL() throws RecognitionException {
        ...
        try {
            // InternalWappm.g:1106:43: (iv_ruleURL= ruleURL EOF )
            // InternalWappm.g:1107:2: iv_ruleURL= ruleURL EOF
            {
    ...
    // $ANTLR start "ruleURL"
    // InternalWappm.g:1113:1: ruleURL returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (kw= '/' (this_ID_1= RULE_ID kw= '/' )* ) ;
    public final AntlrDatatypeRuleToken ruleURL() throws RecognitionException {
        ...
        try {
            // InternalWappm.g:1119:2: ( (kw= '/' (this_ID_1= RULE_ID kw= '/' )* ) )
            // InternalWappm.g:1120:2: (kw= '/' (this_ID_1= RULE_ID kw= '/' )* )
            {
            // InternalWappm.g:1120:2: (kw= '/' (this_ID_1= RULE_ID kw= '/' )* )
            // InternalWappm.g:1121:3: kw= '/' (this_ID_1= RULE_ID kw= '/' )*
            {
            ...
            // InternalWappm.g:1126:3: (this_ID_1= RULE_ID kw= '/' )*
            loop13:
            do {
                int alt13=2;
                ...
                switch (alt13) {
            	case 1 :
            	    // InternalWappm.g:1127:4: this_ID_1= RULE_ID kw= '/'
            	    {
    ...
    // InternalWappm.g:1144:1: ruleAppTypes returns [Enumerator current=null] : ( (enumLiteral_0= 'String' ) | (enumLiteral_1= 'Integer' ) | (enumLiteral_2= 'Float' ) | (enumLiteral_3= 'Double' ) | (enumLiteral_4= 'Boolean' ) ) ;
    public final Enumerator ruleAppTypes() throws RecognitionException {
        ...
        try {
            // InternalWappm.g:1150:2: ( ( (enumLiteral_0= 'String' ) | (enumLiteral_1= 'Integer' ) | (enumLiteral_2= 'Float' ) | (enumLiteral_3= 'Double' ) | (enumLiteral_4= 'Boolean' ) ) )
            // InternalWappm.g:1151:2: ( (enumLiteral_0= 'String' ) | (enumLiteral_1= 'Integer' ) | (enumLiteral_2= 'Float' ) | (enumLiteral_3= 'Double' ) | (enumLiteral_4= 'Boolean' ) )
            {
            // InternalWappm.g:1151:2: ( (enumLiteral_0= 'String' ) | (enumLiteral_1= 'Integer' ) | (enumLiteral_2= 'Float' ) | (enumLiteral_3= 'Double' ) | (enumLiteral_4= 'Boolean' ) )
            int alt14=5;
            switch ( input.LA(1) ) {
            ...
            switch (alt14) {
                case 1 :
                    // InternalWappm.g:1152:3: (enumLiteral_0= 'String' )
                    {
                    // InternalWappm.g:1152:3: (enumLiteral_0= 'String' )
                    // InternalWappm.g:1153:4: enumLiteral_0= 'String'
                    {
                    ...
                    break;
                case 2 :
                    // InternalWappm.g:1160:3: (enumLiteral_1= 'Integer' )
                    {
                    // InternalWappm.g:1160:3: (enumLiteral_1= 'Integer' )
                    // InternalWappm.g:1161:4: enumLiteral_1= 'Integer'
                    {
                    ...
                    break;
                case 3 :
                    // InternalWappm.g:1168:3: (enumLiteral_2= 'Float' )
                    {
                    // InternalWappm.g:1168:3: (enumLiteral_2= 'Float' )
                    // InternalWappm.g:1169:4: enumLiteral_2= 'Float'
                    {
                    ...
                    break;
                case 4 :
                    // InternalWappm.g:1176:3: (enumLiteral_3= 'Double' )
                    {
                    // InternalWappm.g:1176:3: (enumLiteral_3= 'Double' )
                    // InternalWappm.g:1177:4: enumLiteral_3= 'Double'
                    {
                    ...
                    break;
                case 5 :
                    // InternalWappm.g:1184:3: (enumLiteral_4= 'Boolean' )
                    {
                    // InternalWappm.g:1184:3: (enumLiteral_4= 'Boolean' )
                    // InternalWappm.g:1185:4: enumLiteral_4= 'Boolean'
                    {
    ...
    public static final BitSet FOLLOW_22 = new BitSet(new long[]{0x0000000028002000L});
    public static final BitSet FOLLOW_23 = new BitSet(new long[]{0x0000000020002000L});
    public static final BitSet FOLLOW_24 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_25 = new BitSet(new long[]{0x0000007C00000000L});
