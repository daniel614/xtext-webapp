...
public class WappmValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(WappmConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	}
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("Wappm");
		if (section == null) {
			return dialogSettings.addNewSection("Wappm");
		}
		return section;
	}
}
